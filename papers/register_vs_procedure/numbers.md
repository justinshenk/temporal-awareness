...
| conditionality index vs LoRA dose (DDXPlus/Qwen-7B) | index 1.04/0.90/0.79/0.71 at doses 25/75/225/600; steerable accuracy flat ~0.57-0.64 while ceiling climbs 0.68->0.97 — the bias is learned first | `map_transfer/dose_curve_evals.json`, `2026-08-21-conditionality-dose-curve.md` | 2026-08-21 |
