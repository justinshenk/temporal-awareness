...
\title{Accumulation Is Free, Dilution Is Not:\\A Within-Harness Causal Test of Context Rot}
...
of competence with length; it is dilution of the evidence, and it is dose-dependent in attention
mass. \emph{We also withdraw a positive result from an earlier version of this work} (\S6).
\end{abstract}
...
With accumulation and dilution separated inside one harness: accumulation produces a real, monotone
...
plausibly instrument-limited. The clamp is uniform across heads. The instruction-canary null is a
