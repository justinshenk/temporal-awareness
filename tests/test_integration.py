...
class TestComponentBackendEquivalence:
    ...
    def test_intervention_equivalence(
        ...
        tl_logits = transformerlens_runner.run_with_intervention(
            prompt, intervention
        )
...
def make_test_prompt_dataset(
    ...
    from src.intertemporal.prompt.prompt_dataset_config import ContextConfig, OptionRangeConfig
...
class TestQueryDatasetIntegration:
    ...
    def test_query_dataset_real_model(self, transformerlens_runner, tmp_path):
        ...
        from src.intertemporal.preference.preference_querier import PreferenceQuerier, QueryConfig
...
class TestPreferenceQuerierIntervention:
    ...
    def test_query_config_with_intervention_loads(self):
        ...
        from src.intertemporal.preference.preference_querier import QueryConfig
