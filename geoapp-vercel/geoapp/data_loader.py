...
class GeometryDataLoader:
    ...
    def get_markers(self) -> dict[str, str]:
        ...
        Vendored from DefaultPromptFormat.prompt_const_keywords so this deploy
        stays self-contained (the original imports src.common, which pulls in the
        heavy research package tree).
        """
        return {
            "situation_marker": "SITUATION:",
            "task_marker": "TASK:",
