...
from src.intertemporal.data.default_configs import DEFAULT_MODEL, TEST_PROMPT_DATASET_CONFIG
from src.intertemporal.preference import PreferenceQuerier, QueryConfig, PreferenceDataset
...
def load_config(args) -> QueryConfig:
    ...
    return (
        QueryConfig.from_dict(config_dict),
