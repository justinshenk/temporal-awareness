...
from .viz.aggregated import plot_aggregated_structured, plot_all_aggregated_slices
from .viz.coarse_comparison import plot_comparison
from .viz.component_comparison import plot_all_component_comparisons
from .viz.coarse_redundancy import plot_redundancy
from .viz.coarse_sanity import plot_sanity_check
from .viz.fork_comparison import plot_fork_comparison
...
def visualize_component_comparison(
    ...
    """
    from ..analysis import compute_component_comparison_from_pair
