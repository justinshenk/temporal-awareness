...
from ...common.file_io import ensure_dir, save_json, get_timestamp
from ..common.project_paths import get_experiment_dir
...
from .steering_vectors import compute_steering_vector, apply_steering
...
@profile("step_contrastive_steering")
...
def run_experiment(config: ExperimentConfig) -> None:
    ...
    xlog("\n" + pref_data.to_string(without_long_sequences=True))
