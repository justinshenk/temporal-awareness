...
CHOICE_PREFIX = _DEFAULT_FORMAT.prompt_const_keywords["format_choice_prefix"]
CONSIDER_MARKER = _DEFAULT_FORMAT.prompt_const_keywords["consider_marker"]
...
def find_section_markers(
    ...
    def text_pos_to_token_pos(text_pos: int) -> int:
        ...
        prefix_formatted = runner.apply_chat_template(prefix)
...
def get_token_labels(runner: "ModelRunner", text: str) -> list[str]:
    ...
    """
    formatted = runner.apply_chat_template(text)
