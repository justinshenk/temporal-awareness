...
Ronen Raj Roy & Context fatigue in long contexts & Entropy collapse is real; partially offset by ICL & Publication \\
Harleen Bagga & Sycophancy detection via hidden states & Sycophancy rare (1.5--15.5\%); confidence unreliable as monitor & Publication \\
...
\textbf{Target venues.} We aim for NeurIPS 2026 (main conference or workshops) for the strongest results, with blog posts and web demos for preliminary or negative findings. The baseline staircase methodology (Bijoor) and temporal steering results (Obiso, Paudel) are the most publication-ready.
